...
export const characterIcons: CharacterIcon[] = [
  ...
  { eng: 'Peach', jp: 'ピーチ/デイジー', anotation: ['peach', 'daisy'], path: '/images/chara_icon/Peach 0.png' },
  ...
  { eng: 'Pyra', jp: 'ホムラ/ヒカリ', anotation: ['pyra', 'mythra'], path: '/images/chara_icon/Pyra 0.png' },
  ...
  { eng: 'Sephiroth', jp: 'セフィロス', anotation: ['sephiroth', 'sephiroth2'], path: '/images/chara_icon/Sephiroth 0.png' },
  ...
  { eng: 'Sora', jp: 'ソラ', anotation: ['sora', 'sora2'], path: '/images/chara_icon/Sora 0.png' },
